...
# Create metadata that includes the source filename for each chunk
metadatas = [{'source': chunk.metadata['source']} for chunk in texts_chunks]

collection.add(
    documents=list_of_texts,
    embeddings=embeddings.tolist(),
    metadatas=metadatas, # <-- CHANGE: Metadata is now added here
    ids=ids
)
